        ...
        <div>
            <section className="dark:bg-gray-900 dark:text-gray-100">
                <div className="container flex flex-col-reverse mx-auto lg:flex-row">
                    <div className="flex flex-col px-6 py-8 space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 dark:bg-violet-400 dark:text-gray-900">
                        <div className="flex space-x-2 sm:space-x-4">
                            ...
                            <div className="space-y-2">
                                <p className="text-lg font-medium leading-snug">Add Task</p>
                        ...
                        <div className="flex space-x-2 sm:space-x-4">
                            ...
                            <div className="space-y-2">
                                <p className="text-lg font-medium leading-snug">My Task</p>
                                <p className="leading-snug">Praesentium ea et neque distinctio quas eius repudiandae quaerat obcaecati voluptatem similique!</p>
                            </div>
                        </div>
                        <div className="flex space-x-2 sm:space-x-4">
                            ...
                            <div className="space-y-2">
                                <p className="text-lg font-medium leading-snug">Complete Task</p>
                                <p className="leading-snug">Praesentium ea et neque distinctio quas eius repudiandae quaerat obcaecati voluptatem similique!</p>
                            </div>
                        </div>
                        <div className="flex space-x-2 sm:space-x-4">
                    ...
                    <div className="lg:w-1/2 xl:w-3/5 dark:bg-gray-900">
