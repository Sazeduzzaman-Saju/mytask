...
function Feature() {
    ...
    return (
        <div class="container my-24 px-6 mx-auto dark:text-white dark:bg-slate-900">


            <section class="mb-32 text-gray-800 dark:text-white">
                <div class="flex flex-wrap items-center">
                    <div class="grow-0 shrink-0 basis-auto w-full lg:w-4/12 mb-6 md:mb-0 px-3">
                        <h2 class="text-3xl font-bold mb-6">
                            Why is it so<u class="text-blue-600 dark:text-white"> great?</u>
                        </h2>
